...
class TestSeed:
    ...
    @pytest.fixture
    def seed42_tensor1(self) -> torch.IntTensor:
        return torch.tensor(
    ...
    @pytest.fixture
    def seed42_tensor2(self) -> torch.IntTensor:
        return torch.tensor(
    ...
    @pytest.fixture
    def seed3407_tensor(self) -> torch.IntTensor:
        return torch.tensor(
    ...
    @pytest.fixture
    def seed534895718_tensor(self) -> torch.IntTensor:
        return torch.tensor(
    ...
    @pytest.fixture
    def seed198276314_tensor(self) -> torch.IntTensor:
        return torch.tensor(
    ...
    def test_init_seed(
        self,
        seed42_tensor1: torch.IntTensor,
        seed42_tensor2: torch.IntTensor,
        seed534895718_tensor: torch.IntTensor,
        seed198276314_tensor: torch.IntTensor,
    ) -> None:
        init_seed(42)
    ...
    def test_set_seed_temp(
        ...
        seed42_tensor1: torch.IntTensor,
        seed42_tensor2: torch.IntTensor,
        seed3407_tensor: torch.IntTensor,
    ) -> None:
        init_seed(42)
        randint = torch.randint(0, 100, (10, ))
        assert randint.eq(seed42_tensor1).all()
